...
bike = vehicle(color="yellow")
print(bike.color) #yellow

#A method is a function defined inside the class.Method are called with the class object. they can't
#be called independently.Here "description is the method (function defiend inside the class )
