#If a fucntion takes anothers as a parameter then it is called as
#Higher order function
#Examples are sort() method of list ,map(),reduce(),filter(),decorators etc.

#map()= It is a buuilt in functions which takes two paramters.First paramter is a function and second
...
# actual data, we need to convert it to some other datatypes
print(list(result))# [16, 17, 18, 19, 20]


def power_by_two(element):
    return element ** 2

result = map(power_by_two,nums)
